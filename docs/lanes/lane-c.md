...
| C9 | done: schedule-blind worst case (decision 013), the same worst tactics with random entry phases, on the report, deck, write-up and console; `results/v4/`. At $55/h the worst case is 0.04 with the schedule and 0.53 without; d3 stagger holds 0.49 either way | `score/logreport/sweep.py`, `redteam/objective.py`; `airtight-sweep` (default on) |
