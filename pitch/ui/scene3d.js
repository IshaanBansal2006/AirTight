...
$('#mapLead').textContent = `The site to scale with the recorded night played over it: the fleet, what each agent can see, and the intruder's path coloured by time.${rounds.length ? ' Red-team round paths are the routes that still landed after each round of fixes.' : ''}`;
